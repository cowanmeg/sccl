...
class SCCLProgram:
    def __init__(self, name, topo, collective, instances, protocol='Simple', \
        ...
        self.trace = [] # Trace of the programs ChunkOperations and scheduling annotations
    ...
    def print_chunk_dag(self):
        visualize_chunk_dag(self.chunk_dag.routes)
...
#     def __init__(self):
#         self.chunks = []
#         self.routes = {} # chunk -> ChunkOp
#         self.last_reduce = {} # chunk -> last reduce
#         self.last_copies = {} # chunk -> last copies
#         self.max_hops = -1
...
#         self.routes[chunk] = op

    # def _find_prev_op_for_chunk(self, chunk, ref):
    #     prev_op = None
    #     frontier = [self.routes[chunk]]
    ...
    #     for chunk, op in self.routes.items():
